...
class nienKhoa 
{
    ...
    public function insert_categori($catName){
        ...
        if(empty($catName)){
            ...
            $query = "insert into nienkhoa(nienKhoa) values('$catName')";
    ...
    public function update_categori($catName,$id){
        ...
        if(empty($catName)){
            ...
            $query = "update nienkhoa set nienKhoa = '$catName' Where id = '$id'";
    ...
    public function show_categori(){
        $query = "select * from nienkhoa order by id desc";
        $result = $this->db->select($query);
        return $result;
    }
    public function del_categori($id){
        $query = "delete from nienkhoa where id = '$id'";
    ...
    public function getcatbyId($id){
        $query = "select * from nienkhoa where id='$id'";
        $result = $this->db->select($query);
        return $result;
    }
