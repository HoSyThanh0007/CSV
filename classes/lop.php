...
class lop 
{
    ...
    public function insert_categori($catName){
        ...
        if(empty($catName)){
            ...
            $query = "insert into lop(tenLop) values('$catName')";
    ...
    public function update_categori($catName,$id){
        ...
        if(empty($catName)){
            ...
            $query = "update lop set tenLop = '$catName' Where id = '$id'";
    ...
    public function show_categori(){
        $query = "select * from lop order by id desc";
    ...
    public function getcatbyId($id){
        $query = "select * from lop where id='$id'";
        $result = $this->db->select($query);
        return $result;
    }
